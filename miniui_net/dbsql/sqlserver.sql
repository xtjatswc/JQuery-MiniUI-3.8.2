...
GO
INSERT [dbo].[t_department] ([id], [name], [manager]) VALUES (N'sc', N'市场销售部', NULL)
INSERT [dbo].[t_department] ([id], [name], [manager]) VALUES (N'rs', N'人事部', NULL)
INSERT [dbo].[t_department] ([id], [name], [manager]) VALUES (N'js', N'技术部', NULL)
INSERT [dbo].[t_department] ([id], [name], [manager]) VALUES (N'cw', N'财务部', NULL)
