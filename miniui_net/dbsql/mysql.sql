...
INSERT INTO `plus_file` (`id`, `name`, `type`, `size`, `url`, `pid`, `createdate`, `updatedate`, `folder`, `num`) VALUES
  ...
  ('11','Description.rtf','rtf',NULL,NULL,'1',NULL,NULL,0,NULL),
  ('12','n.txt','txt',NULL,NULL,'1',NULL,NULL,0,NULL),
  ('13','o.txt','txt',NULL,NULL,'1',NULL,NULL,0,NULL),
  ('14','file1.txt','txt',NULL,NULL,'2',NULL,NULL,0,NULL),
  ('15','file2.txt','txt',NULL,NULL,'2',NULL,NULL,0,NULL),
  ('16','file3.txt','txt',NULL,NULL,'3',NULL,NULL,0,NULL),
  ('17','file4.txt','txt',NULL,NULL,'3',NULL,NULL,0,NULL),
  ('18','file5.txt','txt',NULL,NULL,'4',NULL,NULL,0,NULL),
  ('19','file6.txt','txt',NULL,NULL,'5',NULL,NULL,0,NULL),
  ('2','Documents',NULL,NULL,NULL,'1',NULL,NULL,1,NULL),
  ('20','file7.txt','txt',NULL,NULL,'6',NULL,NULL,0,NULL),
  ('21','file8','txt',NULL,NULL,'7',NULL,NULL,0,NULL),
  ('22','file9','txt',NULL,NULL,'8',NULL,NULL,0,NULL),
  ('3','Images',NULL,NULL,NULL,'1',NULL,NULL,1,NULL),
  ('4','Music',NULL,NULL,NULL,'1',NULL,NULL,1,NULL),
  ('5','System',NULL,NULL,NULL,'1',NULL,NULL,1,NULL),
  ('6','Video',NULL,NULL,NULL,'1',NULL,NULL,1,NULL),
  ('7','Projects',NULL,NULL,NULL,'2',NULL,NULL,1,NULL),
  ('8','Reports',NULL,NULL,NULL,'2',NULL,NULL,1,NULL),
